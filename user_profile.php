        ...
        <div class="row">
            <div class="col-lg-4 mb-4">
                ...
                <div class="profile-header p-4 text-center mb-4">
                    <?php
                    $stmtprofile = $conn->prepare("SELECT first_name, last_name, username, email, interests, created_at FROM users WHERE id = ?");
                    $stmtprofile->bind_param("i",$profile_id);
                    $stmtprofile->execute();
                    ...
                    <h3 id="profileName"><?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?></h3>
                    <p class="mb-2"><i class="fas fa-at me-2"></i><span id="profileUsername"><?= $user['username'] ?></span></p>
                    <p class="mb-0"><i class="fas fa-envelope me-2"></i><span id="profileEmail"><?= $user['email'] ?></span></p>
                </div>
                ...
                <div class="profile-card p-4">
                    ...
                    <p><i class="fas fa-clock me-2"></i><span id="joinDate"> <?= date('M d, Y',strtotime($user['created_at'])) ?></span></p>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                ...
                <div class="profile-card p-4 mb-4">
                    ...
                    $stmtthreads->bind_param("i", $profile_id);
                    $stmtthreads->execute();
                    ...
                    $stmtreplies->bind_param("i",$profile_id);
                    $stmtreplies->execute();
                ...
                <div class="profile-card p-4">
                    ...
                    <div class="list-group">
                        <?php
                                ...
                                $stmtrecentthread->bind_param("i",$profile_id);
